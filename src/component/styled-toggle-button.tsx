...
import './styled-toggle-button.css';
    ...
    return (
        <>
            <button
                ...
                style={{ height: '90%', width: 'auto', maxHeight: 50, justifyContent: 'flex-end' }}>
